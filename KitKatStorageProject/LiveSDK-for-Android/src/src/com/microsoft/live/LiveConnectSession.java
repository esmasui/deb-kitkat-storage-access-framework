...
public class LiveConnectSession {
    ...
    /**
     * Adds a {@link java.beans.PropertyChangeListener} to the session that receives notification when any
     * property is changed.
     *
     * @param listener
     */
    ...
    /**
     * Adds a {@link java.beans.PropertyChangeListener} to the session that receives notification when a
